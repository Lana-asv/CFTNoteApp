...
SWIFT_CLASS("_TtC8NotesApp23EnterNoteViewController")
@interface EnterNoteViewController : UIViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
- (void)saveButton;
- (IBAction)sizeFontChange:(id _Nonnull)sender;
- (IBAction)boldButton:(id _Nonnull)sender;
- (IBAction)italicButton:(id _Nonnull)sender;
- (IBAction)underlineButton:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8NotesApp14ViewController")
